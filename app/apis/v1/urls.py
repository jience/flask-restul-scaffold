...
api_v1.add_resource(UserResource, '/user/<int:user_id>', endpoint='user')
api_v1.add_resource(UserResource, '/user', endpoint='users')
api_v1.add_resource(PostResource, '/post/<int:post_id>', endpoint='post')
api_v1.add_resource(PostResource, '/post', endpoint='posts')
api_v1.add_resource(CategoryResource, '/category/<int:category_id>', endpoint='category')
